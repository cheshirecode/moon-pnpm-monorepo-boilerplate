...
[![npm version](https://badge.fury.io/js/@fieryeagle%2Feslint-config-react.svg)](https://badge.fury.io/js/@fieryeagle%2Feslint-config-react)
...
```js
module.exports = require('@fieryeagle/eslint-config-react');
```
