...
- bac87a1: Unify all publishable packages under the `@cheshirecode` scope. The previously
...
- 301246c: fix: add .prettierrc.js subpath export to package.json for boundary compliance
